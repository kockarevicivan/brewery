...
{
    public interface IBeerManager : IDisposable
    {
        /// <summary>
        /// Inserts the provided Beer object into repository.
        /// </summary>
        ...
        /// <summary>
        /// Returns all Beer objects inside the repository.
        /// </summary>
        /// <returns>IEnumerable of all beer objects inside the repository.</returns>
        ...
        /// <summary>
        /// Finds the beer by provided id and removes it from the repository.
        /// </summary>

...
{
    public interface IBreweryManager : IDisposable
    {
        /// <summary>
        /// Inserts the provided Brewery object into repository.
        /// </summary>
        ...
        /// <summary>
        /// Returns all Brewery objects inside the repository.
        /// </summary>
        /// <returns>IEnumerable of all Brewery objects inside the repository.</returns>
        ...
        /// <summary>
        /// Finds the brewery by provided id and removes it from the repository.
        /// </summary>
